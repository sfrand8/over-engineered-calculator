...
require (
	...
	github.com/sfrand8/over-engineered-calculator/pkg/http-client v0.0.0-00010101000000-000000000000
...
replace github.com/sfrand8/over-engineered-calculator/pkg/http-client => ./pkg/http-client
